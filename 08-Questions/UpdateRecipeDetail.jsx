...
const RecipeDetail = () => {
    ...
    const handleCommentClick = (e) => {
        ...
        // Hvis der klikkes på en slet-knap, håndter det separat
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.commentsContainer}>
                <h3>Comments</h3>
                <div style={styles.comments} onClick={handleCommentClick}> // tilføjte en onClick-handler til containeren for event bubbling
